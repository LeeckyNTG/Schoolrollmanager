    ...
    <FORM id="userInfo" method="post">
	        ...
	        <DIV style="float: left;top: 0px">
		      ...
		      <DIV style="float: right top: 0px">
	            <DIV  class="controls" >出生年月&nbsp;&nbsp;
	            	<INPUT class="input_from" name="sBorn"id="sBorn" type="date" placeholder="请输入出生年月(xxxx-xx-xx)">
	            	</DIV>
	        </DIV>
        </div>
          <!--第四行  -->
	        ...
	        <DIV style="float: left;top: 0px">
		      ...
		      <DIV style="float: right top: 0px">
	            <DIV  class="controls" >入学时间&nbsp;&nbsp;
	            	<INPUT class="input_from" name="sAdmissionDate"id="sAdmissionDate"type="date" placeholder="请输入入学时间(xxxx-xx-xx)">
	            	</DIV>
	        </DIV>
        </div>
         <!--第六行  -->
        ...
        <div style="width: 100%" class="control-group">
	        <DIV style="float: left;top: 0px">
		        ...
		        <DIV style="float: right top: 0px"class="control-group">
		            <DIV  class="controls" >政治面貌&nbsp;&nbsp;
	              		<SELECT class="input_select" name="politicaloutlook">
         ...
         <div style="padding-left: 170px;float: left;padding-bottom: 20px">
		            <input type="button" name="addInfo_btn" id="button_logo" class="button_logo" value="确定"/>
		        </div>
    </FORM>
</div>
  </body>
